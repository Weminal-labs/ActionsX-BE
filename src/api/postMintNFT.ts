import {
  ...
  export async function postMintNFT(
    req: Request,
    res: Response
  ): Promise<void>
  {
    ...
    try {
      ...
      const NFT_MODULE = "0x5a44ff76148e3ebdfcedcbf0408ba49844561f7c7db4e5c71e3652d3b7183190::minting::mint_nft";
      const transaction: any = {
        data: {
            function: NFT_MODULE,
            typeArguments: [],
            functionArguments: [
                quanity as AnyNumber,
            ],
        }
      }
      const payload = {
